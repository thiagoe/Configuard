...
const defaultAdvancedConfig: TemplateAdvancedConfig = {
  ...
  login_success_pattern_enabled: false,
...
const BackupTemplates = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload: BackupTemplateCreate | BackupTemplateUpdate = {
      ...
      login_success_pattern: advancedConfig.login_success_pattern_enabled ? advancedConfig.login_success_pattern : "",
  ...
  const openDialog = (template?: BackupTemplate) => {
    if (template) {
      ...
      setAdvancedConfig({
        ...
        login_success_pattern_enabled: template.login_success_pattern !== null && template.login_success_pattern !== undefined ? template.login_success_pattern !== "" : false,
  ...
  const templateToExportFormat = (template: BackupTemplate) => {
    const exportTemplate: Record<string, unknown> = {
      ...
      login_success_pattern: template.login_success_pattern || null,
    ...
    for (const template of selectedList) {
      try {
        ...
        await createMutation.mutateAsync({
          ...
          login_success_pattern: template.login_success_pattern || undefined,
      ...
      for (const templateData of templatesToImport) {
        try {
          ...
          await createMutation.mutateAsync({
            ...
            login_success_pattern: templateData.login_success_pattern || undefined,
